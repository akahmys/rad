...
- Strictly adhere to all rules in [CODING_RULES.md](file://~/projects/rad/CODING_RULES.md) (Clippy, file/function size, test separation, safety, security).
...
- Keep files and functions within limits defined in [CODING_RULES.md](file://~/projects/rad/CODING_RULES.md).

### Step 3: Strict Audit & Auto-Commit
Perform verification in this strict order:
1. **Self-Size Check**: Verify compliance with [CODING_RULES.md](file://~/projects/rad/CODING_RULES.md) size limits before compiling. Refactor immediately if violated.
