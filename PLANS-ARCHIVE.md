...
Phases 70 and earlier, moved out of `PLANS.md` during stage 9 of the microkernel
migration. Kept whole rather than summarised: it is the record of how the
current design was arrived at, and none of it is derivable from the code.
