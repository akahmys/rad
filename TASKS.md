...
## Version 0.2.1 OpenAI-Compatible Wasm Extension
- [x] AWU 16: Setup Wasm Extension Cargo Project
...
- [x] AWU 19: Add WriteStdout RPC and Refactor to Decouple Stream Parsing
  - [x] Add `WriteStdout` RPC to `RasRpcCommand`
